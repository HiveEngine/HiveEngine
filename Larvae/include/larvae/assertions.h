...
namespace larvae
{
    ...
    void AssertEqual(const T1& val1, const T2& val2,
        ...
        if (!(val1 == val2))
        {
            ...
            actual_ss << val1;
            expected_ss << val2;
            HandleAssertionFailure(FormatAssertionMessage(loc.file_name(), loc.line(), "equality check",
    ...
    void AssertNotEqual(const T1& val1, const T2& val2,
        ...
        if (!(val1 != val2))
        {
            ...
            ss << val1;
            HandleAssertionFailure(FormatAssertionMessage(loc.file_name(), loc.line(), "inequality check",
                                                          "values should differ", ss.str()));
        }
    }
    ...
    void AssertLessThan(const T1& val1, const T2& val2,
        ...
        if (!(val1 < val2))
        {
            ...
            actual_ss << val1;
            expected_ss << "< " << val2;
            HandleAssertionFailure(FormatAssertionMessage(loc.file_name(), loc.line(), "less than check",
                                                          expected_ss.str(), actual_ss.str()));
        }
    }
    ...
    void AssertLessEqual(const T1& val1, const T2& val2,
        ...
        if (!(val1 <= val2))
        {
            ...
            actual_ss << val1;
            expected_ss << "<= " << val2;
            HandleAssertionFailure(FormatAssertionMessage(loc.file_name(), loc.line(), "less equal check",
                                                          expected_ss.str(), actual_ss.str()));
        }
    }
    ...
    void AssertGreaterThan(const T1& val1, const T2& val2,
        ...
        if (!(val1 > val2))
        {
            ...
            actual_ss << val1;
            expected_ss << "> " << val2;
            HandleAssertionFailure(FormatAssertionMessage(loc.file_name(), loc.line(), "greater than check",
                                                          expected_ss.str(), actual_ss.str()));
        }
    }
    ...
    void AssertGreaterEqual(const T1& val1, const T2& val2,
        ...
        if (!(val1 >= val2))
        {
            ...
            actual_ss << val1;
            expected_ss << ">= " << val2;
            HandleAssertionFailure(FormatAssertionMessage(loc.file_name(), loc.line(), "greater equal check",
                                                          expected_ss.str(), actual_ss.str()));
        }
    }
    ...
    void AssertNear(const T1& val1, const T2& val2, const Epsilon& epsilon,
        ...
        if (std::abs(val1 - val2) > epsilon)
        {
            ...
            HandleAssertionFailure(FormatAssertionMessage(loc.file_name(), loc.line(), "near check", ss.str(), ""));
        }
    }
