...
namespace
{
    ...
    auto t1 = larvae::RegisterTest("NectarHiveParser", "EmptyDocument", []() {
        ...
        larvae::AssertEqual(result.m_document.Sections().Count(), size_t{0});
    });
    ...
    auto t3 = larvae::RegisterTest("NectarHiveParser", "EmptySection", []() {
        ...
        larvae::AssertTrue(result.Success());
        larvae::AssertTrue(result.m_document.HasSection("empty"));
    });
    ...
    auto t4 = larvae::RegisterTest("NectarHiveParser", "BlankLinesIgnored", []() {
        ...
        larvae::AssertTrue(result.Success());
        auto sv = result.m_document.GetString("sec", "key");
    ...
    auto t5 = larvae::RegisterTest("NectarHiveParser", "StringValue", []() {
        ...
        larvae::AssertTrue(result.Success());
        auto* v = result.m_document.GetValue("s", "name");
        larvae::AssertNotNull(v);
        larvae::AssertTrue(v->m_type == nectar::HiveValue::Type::STRING);
    ...
    auto t6 = larvae::RegisterTest("NectarHiveParser", "BoolValues", []() {
        ...
        auto result = nectar::HiveParser::Parse("[s]\na = true\nb = false\n", alloc);
        larvae::AssertTrue(result.Success());
        larvae::AssertEqual(result.m_document.GetBool("s", "a"), true);
        larvae::AssertEqual(result.m_document.GetBool("s", "b"), false);
    });
    ...
    auto t7 = larvae::RegisterTest("NectarHiveParser", "IntValue", []() {
        ...
        auto result = nectar::HiveParser::Parse("[s]\ncount = 42\n", alloc);
        larvae::AssertTrue(result.Success());
        larvae::AssertEqual(result.m_document.GetInt("s", "count"), int64_t{42});
    });
    ...
    auto t8 = larvae::RegisterTest("NectarHiveParser", "NegativeInt", []() {
        ...
        auto result = nectar::HiveParser::Parse("[s]\nval = -100\n", alloc);
        larvae::AssertTrue(result.Success());
        larvae::AssertEqual(result.m_document.GetInt("s", "val"), int64_t{-100});
    });
    ...
    auto t9 = larvae::RegisterTest("NectarHiveParser", "FloatValue", []() {
        ...
        auto result = nectar::HiveParser::Parse("[s]\nratio = 0.5\n", alloc);
        larvae::AssertTrue(result.Success());
        larvae::AssertDoubleEqual(result.m_document.GetFloat("s", "ratio"), 0.5);
    });
    ...
    auto t10 = larvae::RegisterTest("NectarHiveParser", "FloatScientific", []() {
        ...
        auto result = nectar::HiveParser::Parse("[s]\nval = 1.5e3\n", alloc);
        larvae::AssertTrue(result.Success());
        larvae::AssertDoubleEqual(result.m_document.GetFloat("s", "val"), 1500.0);
    });
    ...
    auto t11 = larvae::RegisterTest("NectarHiveParser", "StringArray", []() {
        ...
        auto result = nectar::HiveParser::Parse("[s]\ntags = [\"a\", \"b\", \"c\"]\n", alloc);
        larvae::AssertTrue(result.Success());
        auto* v = result.m_document.GetValue("s", "tags");
        larvae::AssertNotNull(v);
        larvae::AssertTrue(v->m_type == nectar::HiveValue::Type::STRING_ARRAY);
    ...
    auto t13 = larvae::RegisterTest("NectarHiveParser", "MultipleSections", []() {
        auto& alloc = GetParserAlloc();
        const char* input = "[identity]\n"
                            "uuid = \"abc123\"\n"
                            "[import]\n"
                            "format = \"BC7\"\n";
        auto result = nectar::HiveParser::Parse(input, alloc);
        larvae::AssertTrue(result.Success());
        larvae::AssertTrue(result.m_document.HasSection("identity"));
        larvae::AssertTrue(result.m_document.HasSection("import"));
        larvae::AssertTrue(result.m_document.GetString("identity", "uuid").Equals("abc123"));
        larvae::AssertTrue(result.m_document.GetString("import", "format").Equals("BC7"));
    });
    ...
    auto t14 = larvae::RegisterTest("NectarHiveParser", "DottedSection", []() {
        ...
        auto result = nectar::HiveParser::Parse(input, alloc);
        larvae::AssertTrue(result.Success());
        larvae::AssertTrue(result.m_document.HasSection("import.platform.mobile"));
        larvae::AssertTrue(result.m_document.GetString("import", "format").Equals("BC7"));
    ...
    auto t15 = larvae::RegisterTest("NectarHiveParser", "EscapedQuotes", []() {
        ...
        auto result = nectar::HiveParser::Parse("[s]\nval = \"say \\\"hi\\\"\"\n", alloc);
        larvae::AssertTrue(result.Success());
        larvae::AssertTrue(result.m_document.GetString("s", "val").Equals("say \"hi\""));
    });
    ...
    auto t17 = larvae::RegisterTest("NectarHiveParser", "WhitespaceAroundEquals", []() {
        ...
        auto result = nectar::HiveParser::Parse("[s]\n  key  =  \"val\"  \n", alloc);
        larvae::AssertTrue(result.Success());
        larvae::AssertTrue(result.m_document.GetString("s", "key").Equals("val"));
    });
    ...
    auto t24 = larvae::RegisterTest("NectarHiveParser", "FallbackOnMissingKey", []() {
        ...
        auto result = nectar::HiveParser::Parse("[s]\n", alloc);
        larvae::AssertTrue(result.Success());
        larvae::AssertEqual(result.m_document.GetInt("s", "missing", 999), int64_t{999});
        larvae::AssertEqual(result.m_document.GetBool("s", "missing", true), true);
    ...
    auto t25 = larvae::RegisterTest("NectarHiveParser", "FullTextureHive", []() {
        auto& alloc = GetParserAlloc();
        const char* input = "# hero.png.hive\n"
                            "\n"
                            "[identity]\n"
        ...
        larvae::AssertTrue(result.m_document.GetString("identity", "uuid").Equals("a3b5c7d9e1f2a3b5c7d9e1f2a3b5c7d9"));
        larvae::AssertTrue(result.m_document.GetString("identity", "type").Equals("Texture"));
        larvae::AssertTrue(result.m_document.GetString("import", "format").Equals("BC7"));
        larvae::AssertEqual(result.m_document.GetBool("import", "generate_mipmaps"), true);
        larvae::AssertEqual(result.m_document.GetInt("import", "max_size"), int64_t{2048});
        larvae::AssertTrue(result.m_document.GetString("import.platform.mobile", "format").Equals("ASTC4x4"));
        larvae::AssertEqual(result.m_document.GetInt("import.platform.mobile", "max_size"), int64_t{1024});

        auto* labels = result.m_document.GetValue("tags", "labels");
    ...
    auto t26 = larvae::RegisterTest("NectarHiveParser", "RoundTrip", []() {
        ...
        auto written = nectar::HiveWriter::Write(result1.m_document, alloc);
        auto result2 = nectar::HiveParser::Parse(written.View(), alloc);
        larvae::AssertTrue(result2.Success());

        larvae::AssertTrue(result2.m_document.GetString("identity", "uuid").Equals("abc"));
        larvae::AssertTrue(result2.m_document.GetString("identity", "type").Equals("Mesh"));
        larvae::AssertEqual(result2.m_document.GetBool("import", "optimize"), true);
        larvae::AssertDoubleEqual(result2.m_document.GetFloat("import", "scale"), 0.01);
    });
