...
namespace nectar
{
    ...
    public:
        ...
        [[nodiscard]] constexpr const char* CStr() const noexcept { return m_buffer; }
    ...
    public:
        ...
        [[nodiscard]] static constexpr ContentHash Invalid() noexcept { return ContentHash{0, 0}; }
        ...
        [[nodiscard]] constexpr bool operator!=(const ContentHash& other) const noexcept { return !(*this == other); }
...
{
    size_t operator()(const nectar::ContentHash& h) const noexcept { return h.Hash(); }
};
