...
namespace
{
    ...
    auto bench1 =
        larvae::RegisterBenchmark("LinearAllocator", "SmallAllocations_64B", [](larvae::BenchmarkState& state) {
    ...
    auto bench2 =
        larvae::RegisterBenchmark("LinearAllocator", "MediumAllocations_1KB", [](larvae::BenchmarkState& state) {
            comb::LinearAllocator allocator{10_MB};
    ...
    auto bench4 =
        larvae::RegisterBenchmark("LinearAllocator", "AlignedAllocations_64B", [](larvae::BenchmarkState& state) {
            comb::LinearAllocator allocator{10_MB};
