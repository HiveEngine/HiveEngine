...
namespace hive
{
    ...
    struct Clock
    {
        ...
        [[nodiscard]] static TimePoint Now() noexcept { return std::chrono::steady_clock::now(); }
    ...
    struct FrameClock
    {
        ...
        [[nodiscard]] float DeltaSeconds() const noexcept { return Clock::SecondsF(m_deltaNs); }

        [[nodiscard]] float ElapsedSeconds() const noexcept { return Clock::SecondsF(m_elapsedNs); }
    };
} // namespace hive
